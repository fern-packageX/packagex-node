 ...
 *         currency: PackagexApi.Currency.Usd,
 *         estimatedDelivery: 1679591515,
 *         filters: [PackagexApi.Filters.Completed],
...
export interface Shipment {
    ...
    filters: PackagexApi.Filters[];
    /** The ID of the fulfillment that created this shipment. */
    fulfillmentId: string;
    /** The unique ID for the shipment */
    id: PackagexApi.ShipmentId;
    refundStatus?: PackagexApi.RefundStatus;
